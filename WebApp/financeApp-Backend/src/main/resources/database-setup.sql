...
-- CREATE INDEX idx_udhaari_user_id ON udhaari(user_id);
-- CREATE INDEX idx_udhaari_date ON udhaari(transaction_date);
-- CREATE INDEX idx_udhaari_type ON udhaari(type);